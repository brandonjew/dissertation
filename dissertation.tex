...
\acknowledgments {First and foremost, I thank my advisors, Eran Halperin and Jae Hoon Sul. I am extremely grateful to have both as amazing mentors who provided me with exciting projects and opportunities to grow as a researcher. I thoroughly enjoyed the last four years with them and I look forward to continuing my journey as a scientist.
...
\abstract       {Large-scale transcriptomic datasets provide valuable opportunities to better understand the regulation of gene expression and its role in human traits. These studies can be confounded by issues such as cell type heterogeneity. Furthermore, these datasets are growing extremely large with complex study designs, such as gene expression measured across a multitude of tissues that must be accurately and efficiently modeled. Furthermore, better understanding of biological mechanisms that influence gene regulation are required to link associations to actionable targets. In this dissertation, we introduce methods that address these issues in the analysis of tissue-level gene expression data. We present a method to accurately estimate cell type composition from these data, as well as a scalable approach to model multi-tissue expression datasets in eQTL analyses. We also present analyses of bulk expression data that validates an additional mechanism of gene regulation in the general female population through non-random X chromosome inactivation. This work allows researchers to perform efficient and accurate analyses of gene expression data and provides additional insight into the mechanisms that underlie associations between genetics, transcriptomics, and complex phenotypes.}
